...
const cardData = [
  { color: 'linear-gradient(135deg, #2a2a32, #3a2020, #2a2a32)', title: 'Hogar', description: 'Refri, calentador, focos e impuestos.', label: '🏠 Hogar', slug: 'hogar', gradient: 'linear-gradient(135deg, #ef4444, #f97316)' },
  { color: 'linear-gradient(135deg, #2a2a32, #1a2a3a, #2a2a32)', title: 'Vehículo', description: 'SOAT, tecnomecánica y frenos.', label: '🚗 Vehículo', slug: 'vehiculo', gradient: 'linear-gradient(135deg, #3b82f6, #06b6d4)' },
  { color: 'linear-gradient(135deg, #2a2a32, #3a1a30, #2a2a32)', title: 'Salud', description: 'Chequeos médicos y dental.', label: '❤️ Salud', slug: 'salud', gradient: 'linear-gradient(135deg, #ec4899, #8b5cf6)' },
  { color: 'linear-gradient(135deg, #2a2a32, #1a3a2a, #2a2a32)', title: 'Finanzas', description: 'Pagos, declaraciones y ahorro.', label: '💰 Finanzas', slug: 'finanzas', gradient: 'linear-gradient(135deg, #10b981, #06b6d4)' },
  { color: 'linear-gradient(135deg, #2a2a32, #2a1a3a, #2a2a32)', title: 'Familia', description: 'Cumpleaños y fechas especiales.', label: '👨‍👩‍👧 Familia', slug: 'familia', gradient: 'linear-gradient(135deg, #8b5cf6, #ec4899)' },
  { color: 'linear-gradient(135deg, #2a2a32, #3a3020, #2a2a32)', title: 'Mascotas', description: 'Vacunas y chequeos veterinarios.', label: '🐾 Mascotas', slug: 'mascotas', gradient: 'linear-gradient(135deg, #f59e0b, #ef4444)' },
];
      ...
      <BentoCardGrid gridRef={gridRef}>
        {data.map((card, index) => {
          ...
          const cardProps = {
            ...
            style: { background: card.color, '--glow-color': glowColor },
          };
            ...
            return (
              ...
              >
                <div className="magic-bento-card__header">
                  <div className="magic-bento-card__label" style={{ background: card.gradient, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>{card.label}</div>
                </div>
